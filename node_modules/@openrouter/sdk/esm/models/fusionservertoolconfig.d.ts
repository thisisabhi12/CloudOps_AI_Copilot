...
/** @internal */
export declare const FusionServerToolConfigEffort$outboundSchema: z.ZodType<string, FusionServerToolConfigEffort>;
/** @internal */
...
/** @internal */
export declare const FusionServerToolConfigReasoning$outboundSchema: z.ZodType<FusionServerToolConfigReasoning$Outbound, FusionServerToolConfigReasoning>;
export declare function fusionServerToolConfigReasoningToJSON(fusionServerToolConfigReasoning: FusionServerToolConfigReasoning): string;
/** @internal */
...
/** @internal */
export declare const FusionServerToolConfigTool$outboundSchema: z.ZodType<FusionServerToolConfigTool$Outbound, FusionServerToolConfigTool>;
export declare function fusionServerToolConfigToolToJSON(fusionServerToolConfigTool: FusionServerToolConfigTool): string;
/** @internal */
...
/** @internal */
export declare const FusionServerToolConfig$outboundSchema: z.ZodType<FusionServerToolConfig$Outbound, FusionServerToolConfig>;
export declare function fusionServerToolConfigToJSON(fusionServerToolConfig: FusionServerToolConfig): string;
//# sourceMappingURL=fusionservertoolconfig.d.ts.map