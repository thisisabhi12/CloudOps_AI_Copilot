 ...
 */
export declare const GetModelsCategory: {
...
export declare const GetModelsSort: {
    ...
    readonly TopWeekly: "top-weekly";
    readonly PricingLowToHigh: "pricing-low-to-high";
    readonly PricingHighToLow: "pricing-high-to-low";
 ...
 */
export declare const Distillable: {
    readonly True: "true";
...
/** @internal */
export declare const GetModelsSort$outboundSchema: z.ZodType<string, GetModelsSort>;
/** @internal */
export declare const Distillable$outboundSchema: z.ZodType<string, Distillable>;
/** @internal */
