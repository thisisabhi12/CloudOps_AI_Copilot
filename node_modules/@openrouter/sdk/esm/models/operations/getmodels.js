...
/** @internal */
export const GetModelsSort$outboundSchema = openEnums.outboundSchema(GetModelsSort);
/** @internal */
export const Distillable$outboundSchema = openEnums.outboundSchema(Distillable);
/** @internal */
