...
export function filtersUnionFromJSON(jsonString) {
    return safeParse(jsonString, (x) => FiltersUnion$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'FiltersUnion' from JSON`);
}
/** @internal */
